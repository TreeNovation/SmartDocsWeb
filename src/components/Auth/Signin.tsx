...
const Signin = () => {
  ...
  const handleGithubLogin = () => {
    ...
    try {
      ...
      // Build GitHub OAuth URL (no specific scopes needed for basic profile)
  ...
  const handleEmailLogin = async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        // Store tokens - typically would be handled by your auth context or state management
      ...
      <section className="pb-12.5 pt-32.5 lg:pb-25 lg:pt-45 xl:pb-30 xl:pt-50">
        <div className="relative z-1 mx-auto max-w-c-1016 px-7.5 pb-7.5 pt-10 lg:px-15 lg:pt-15 xl:px-20 xl:pt-20">
          ...
          >
            ...
            {error && (
              <div className="mb-5 rounded-sm bg-red-50 p-4 text-center text-red-600 dark:bg-red-900/20 dark:text-red-400">
                {error}
              </div>
            )}
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-8">
                ...
                >
                  ...
                  {isLoading.google ? "Connecting..." : "Signup with Google"}
                </button>
                ...
                >
                  ...
                  {isLoading.github ? "Connecting..." : "Signup with Github"}
                </button>
              </div>
            </div>
